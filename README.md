...
Please see [releases](https://github.com/jxpress/buford/releases) for updates.

[![GoDoc](https://godoc.org/github.com/jxpress/buford?status.svg)](https://godoc.org/github.com/jxpress/buford) [![Build Status](https://travis-ci.org/RobotsAndPencils/buford.svg?branch=ci)](https://travis-ci.org/RobotsAndPencils/buford) ![MIT](https://img.shields.io/badge/license-MIT-blue.svg)
...
[API documentation](https://godoc.org/github.com/jxpress/buford/) is available from GoDoc.
...
```
go get -u -d github.com/jxpress/buford
```
...
import (
	...
	"github.com/jxpress/buford/certificate"
